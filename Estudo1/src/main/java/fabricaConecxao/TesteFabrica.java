...
/*		  EntityManager entityManager =
		 ...
		 * riad.setPrimeiro("Jọo"); riad.setSegundo("Carlos"); c1.setNome(riad);
    ...
    c1.setFavoritos(false);
    Nome riad = new Nome();
    riad.setPrimeiro("Jorge");
    riad.setSegundo("Petry");
    c1.setNome(riad);
    c1.setNotas("Alta");
    Telefone t1 = new Telefone();
    Telefone t2 = new Telefone();
    t1.setTelefone("47111111");
    t2.setTelefone("48222222");
